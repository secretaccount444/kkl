   ...
   public class Huku_Glove
   {
      ...
      private function SetFc(param1:int) : void
      {
         if(this.charaData["Glove" + param1]["_visible"][0])
         {
            ...
            this.charaAdd["handm1_" + param1].hand.arm0.hand.actual.mouseChildren = false;
            this.charaAdd["handm1_" + param1].hand.arm0.hand.actual.buttonMode = true;
         }
         else
         {
            this.charaAdd["handm1_" + param1].hand.arm0.hand.actual.glove.visible = false;
            this.charaAdd["handm1_" + param1].hand.arm0.hand.actual.glove.gotoAndStop(1);
            this.charaAdd["handm1_" + param1].hand.arm1.arm1.arm1.actual.Glove.visible = false;
            this.charaAdd["handm1_" + param1].hand.arm1.arm1.arm1.actual.Glove.gotoAndStop(1);
            this.charaAdd["handm1_" + param1].hand.arm1.arm1.arm1.actual.Glove_mask.visible = false;
            this.charaAdd["handm1_" + param1].hand.arm1.arm1.arm1.actual.Glove_mask.gotoAndStop(1);
            this.charaAdd["handm0_" + param1].hand.arm2.actual.arm2.Glove.visible = false;
            this.charaAdd["handm0_" + param1].hand.arm2.actual.arm2.Glove.gotoAndStop(1);
            this.charaAdd["handm0_" + param1].hand.arm2.actual.arm2.Glove_mask.visible = false;
            this.charaAdd["handm0_" + param1].hand.arm2.actual.arm2.Glove_mask.gotoAndStop(1);
            if(param1 == 0)
            {
            ...
            this.charaAdd["handm1_" + param1].hand.arm0.hand.actual.mouseChildren = true;
            this.charaAdd["handm1_" + param1].hand.arm0.hand.actual.buttonMode = false;
         }
      }
