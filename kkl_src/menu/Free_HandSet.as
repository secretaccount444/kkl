   ...
   public class Free_HandSet
   {
      ...
      public function Free_HandSet(param1:int, param2:String)
      {
         ...
         try
         {
            if(this.clickTarget == "menu")
            {
               ...
               if(_loc6_)
               {
                  ...
                  {
                     MenuClass.menuData["FreeHandWrist"] = MenuClass.charaAdd[0].handm1_0.hand.arm0.hand.actual.totalFrames - 1;
                  }
         ...
         if(MenuClass.systemData["FreeHandPlus"]["_visible"][param1])
         {
            ...
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Wristband.visible = true;
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Wristband.gotoAndStop(MenuClass.systemData["FreeHandWristband" + param1]["_menu"] + 2);
            }
            else
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Wristband.visible = false;
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Wristband.gotoAndStop(1);
            }
            if(MenuClass.systemData["FreeHandVest" + param1]["_visible"][0])
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Vest.visible = true;
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Vest.gotoAndStop(Dress_data.FreeHandVestData[MenuClass.systemData["FreeHandVest" + param1]["_menu"]]["arm1"] + 1);
            }
            else
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Vest.visible = false;
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.Vest.gotoAndStop(1);
            }
            if(MenuClass.systemData["FreeHandItem" + param1]["_visible"][0])
            {
               _loc6_ = false;
               ...
               if(_loc6_)
               {
                  ...
                  Chara_Class.chara_m["FreeHand" + param1].item.hand.actual.gotoAndStop(MenuClass.systemData["FreeHandItem" + param1]["_menu"] + 2);
                  if(Dress_data.ObjData["Item0"][MenuClass.systemData["FreeHandItem" + param1]["_menu"]]["arm1"] == 0)
                  {
                     Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.item.visible = false;
                     Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.item.gotoAndStop(1);
                  }
                  else
                  {
                     Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.item.visible = true;
                     Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.item.gotoAndStop(Dress_data.ObjData["Item0"][MenuClass.systemData["FreeHandItem" + param1]["_menu"]]["arm1"] + 1);
                  }
               }
               else
               {
                  MenuClass.systemData["FreeHandItem" + param1]["_visible"][0] = false;
                  Chara_Class.chara_m["FreeHand" + param1].item.hand.actual.gotoAndStop(1);
            ...
            Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.color0.visible = true;
            Chara_Class.chara_m["FreeHand" + param1].arm0.visible = true;
            if(MenuClass.systemData["FreeHand" + param1]["_menu"] <= 5)
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.visible = true;
               try
               {
                  Chara_Class.chara_m["FreeHand" + param1].item.hand.actual.hand.sen.visible = true;
               }
               catch(myError:Error)
               {
               }
               Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.sen0.visible = true;
               try
               {
                  Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.sen1.visible = true;
               }
               catch(myError:Error)
               {
               }
               try
               {
                  Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.kage0.visible = true;
               }
               catch(myError:Error)
               {
               }
            ...
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.visible = false;
               Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.sen0.visible = false;
               try
               {
                  Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.sen1.visible = false;
               }
               catch(myError:Error)
               {
               }
               try
               {
                  Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.kage0.visible = false;
               }
               catch(myError:Error)
               {
               }
               try
               {
                  Chara_Class.chara_m["FreeHand" + param1].item.hand.actual.hand.sen.visible = false;
               }
               catch(myError:Error)
               {
               }
            ...
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.color0.gotoAndStop(1);
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.gotoAndStop(1);
            }
            else if(MenuClass.systemData["FreeHand" + param1]["_menu"] == 1 || MenuClass.systemData["FreeHand" + param1]["_menu"] == 7)
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.color0.gotoAndStop(2);
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.gotoAndStop(2);
            }
            else if(MenuClass.systemData["FreeHand" + param1]["_menu"] == 2 || MenuClass.systemData["FreeHand" + param1]["_menu"] == 8)
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.color0.gotoAndStop(3);
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.gotoAndStop(3);
            }
            else if(MenuClass.systemData["FreeHand" + param1]["_menu"] == 3 || MenuClass.systemData["FreeHand" + param1]["_menu"] == 9)
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.color0.gotoAndStop(4);
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.gotoAndStop(4);
            }
            else if(MenuClass.systemData["FreeHand" + param1]["_menu"] == 4 || MenuClass.systemData["FreeHand" + param1]["_menu"] == 10)
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.color0.gotoAndStop(5);
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.gotoAndStop(5);
            }
            else if(MenuClass.systemData["FreeHand" + param1]["_menu"] == 5 || MenuClass.systemData["FreeHand" + param1]["_menu"] == 11)
            {
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.color0.visible = false;
               Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.visible = false;
            }
            ...
            try
            {
               ...
               while(_loc4_ <= 1)
               {
                  if(Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual["MaskMc" + _loc4_])
                  {
                     Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.sen.mask = Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual["MaskMc" + _loc4_];
                  }
                  _loc4_++;
               }
            }
            ...
            Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.glove.visible = false;
            Chara_Class.chara_m["FreeHand" + param1].arm0.hand.actual.glove.gotoAndStop(1);
            try
            {
               ...
               {
                  _loc16_ = Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.getChildIndex(Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.item);
                  _loc17_ = Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.getChildIndex(Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.itemSwapMc);
                  if(_loc15_)
                  {
                     if(_loc16_ > _loc17_)
                     {
                        Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.swapChildren(Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.item,Chara_Class.chara_m["FreeHand" + param1].arm1.arm1.arm1.actual.itemSwapMc);
                     }
                  }
