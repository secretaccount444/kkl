package menu
{
   public class Chara_Class_First
   {
      ...
      public function Chara_Class_First(param1:int)
      {
         ...
         while(_loc4_ <= 1)
         {
            _loc2_["handm0_" + _loc4_].hand.arm2.actual.arm2.maskMc0.visible = false;
         ...
         while(_loc4_ <= 1)
         {
            ...
            _loc2_["handm1_" + _loc4_].hand.arm0.hand.actual.Num = _loc4_;
            ...
            _loc2_["handm0_" + _loc4_].hand.arm2.actual.arm2.color0.mouseChildren = false;
            _loc2_["handm0_" + _loc4_].hand.arm2.actual.arm2.color0.mouseEnabled = false;
            _loc2_["handm0_" + _loc4_].hand.arm2.actual.arm2.maskMc0.mouseChildren = false;
            _loc2_["handm0_" + _loc4_].hand.arm2.actual.arm2.maskMc0.mouseEnabled = false;
            _loc4_++;
         }
