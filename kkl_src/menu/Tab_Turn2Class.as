package menu
{
   ...
   public class Tab_Turn2Class
   {
      
      public static var targetMC:MovieClip;
       
      
      public function Tab_Turn2Class()
      {
         super();
      }
      ...
      public static function MouseDown(param1:MouseEvent) : void
      {
         ...
         var undoAction = new PropertyAction(
            targetMC.headerName, targetMC.targetJ, "_turn2",
         ...
         var newVal = int(!MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_turn2"]);
         ...
         {
            MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_turn2"] = int(!MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_turn2"]);
            _loc6_ = 0;
            for(; _loc6_ <= MenuClass._characterNum; new SetClass(_loc6_,targetMC.tabName,"tab"),_loc6_++)
            {
               MenuClass.charaData[_loc6_][_loc5_]["_turn2"] = int(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_turn2"]);
               try
               {
         ...
         if(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_turn2"])
         {
