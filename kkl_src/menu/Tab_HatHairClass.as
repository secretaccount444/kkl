package menu
{
   ...
   public class Tab_HatHairClass
   {
      ...
      public function Tab_HatHairClass()
      {
         super();
      }
      
      public static function setFc(param1:MovieClip, param2:int, param3:String, param4:String, param5:Number) : void
      {
      ...
      public static function MouseDown(param1:MouseEvent) : void
      {
         ...
         {
            MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_hair" + targetMC.num] = int(!MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_hair" + targetMC.num]);
            _loc6_ = 0;
            for(; _loc6_ <= MenuClass._characterNum; new SetClass(_loc6_,targetMC.tabName,"tab"),_loc6_++)
            {
               MenuClass.charaData[_loc6_][_loc5_]["_hair" + targetMC.num] = int(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_hair" + targetMC.num]);
               try
               {
         ...
         if(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_hair" + targetMC.num])
         {
