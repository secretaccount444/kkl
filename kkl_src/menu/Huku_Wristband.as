package menu
{
   ...
   public class Huku_Wristband
   {
      ...
      private function SetFc(param1:int) : void
      {
         ...
         {
            this.charaAdd["handm1_" + param1].hand.arm1.arm1.arm1.actual.Wristband.visible = false;
            this.charaAdd["handm1_" + param1].hand.arm1.arm1.arm1.actual.Wristband.gotoAndStop(1);
            this.charaAdd["handm0_" + param1].hand.arm2.actual.arm2.Wristband.visible = false;
            this.charaAdd["handm0_" + param1].hand.arm2.actual.arm2.Wristband.gotoAndStop(1);
         }
      }
