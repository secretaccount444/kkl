package menu
{
   ...
   public class Huku_Ude
   {
      ...
      public function Huku_Ude(param1:String, param2:int, param3:int)
      {
         ...
         if(this.tabName == "Wristband0" || this.tabName == "Wristband1")
         {
            ...
            else if(this.charaData[this.tabName]["_visible"][0])
            {
               ...
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Wristband.visible = true;
            ...
            if(this.charaData[this.tabName]["_visible"][0])
            {
               try
               {
                  ...
                  {
                     this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Wristband.Wristband.gotoAndStop(1);
                  }
                  else
                  {
                     this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Wristband.Wristband.gotoAndStop(2);
                  }
               }
               catch(myError:Error)
               {
         ...
         else if(this.tabName == "Glove0" || this.tabName == "Glove1" || this.tabName == "GloveLength0" || this.tabName == "GloveLength1")
         {
            ...
            else
            {
               ...
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove.visible = true;
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove.gotoAndStop(Dress_data.GloveData[this.menuNum][_loc4_]["arm1_top"] + 1);
               }
               else
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove.visible = false;
               ...
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove_mask.visible = true;
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove_mask.gotoAndStop(Dress_data.GloveData[this.menuNum][_loc4_]["arm1"] + 1);
               }
               else
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove_mask.visible = false;
            ...
            else
            {
               ...
               {
                  this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove.visible = true;
                  this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove.gotoAndStop(Dress_data.GloveData[this.menuNum][_loc4_]["arm2_top"] + 1);
               }
               else
               {
                  this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove.visible = false;
               ...
               {
                  this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove_mask.visible = true;
                  this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove_mask.gotoAndStop(Dress_data.GloveData[this.menuNum][_loc4_]["arm2"] + 1);
               }
               else
               {
                  this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove_mask.visible = false;
            ...
            try
            {
               ...
               if(this.udeAngle >= 1 && this.udeAngle <= 22)
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove.Glove.gotoAndStop(1);
               }
               else
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove.Glove.gotoAndStop(2);
               }
            }
            catch(myError:Error)
            {
            ...
            {
               this.charaAdd["handm1_" + this.handNum].hand.arm0.hand.actual.glove.gotoAndStop(Dress_data.GloveData[this.menuNum][_loc4_]["arm0"] + 1);
               this.charaAdd["handm1_" + this.handNum].hand.arm0.hand.actual.glove.visible = true;
            }
         ...
         {
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Bracelet.visible = this.charaData[this.tabName]["_visible"][0];
            if(this.charaData[this.tabName]["_visible"][0])
            {
               this.menuNum = this.charaData[this.tabName]["_menu"];
               ...
               this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Bracelet.Num = this.handNum;
               new Chara_ColorClass(this.charaNum,this.tabName);
            }
            else
            {
         ...
         {
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.ArmBracelet.visible = this.charaData[this.tabName]["_visible"][0];
            if(this.charaData[this.tabName]["_visible"][0])
            {
               this.menuNum = this.charaData[this.tabName]["_menu"];
               ...
               this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.ArmBracelet.Num = this.handNum;
               new Chara_ColorClass(this.charaNum,this.tabName);
            }
            else
            {
         ...
         {
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Armband.visible = this.charaData[this.tabName]["_visible"][0];
            if(this.charaData[this.tabName]["_visible"][0])
            {
               this.menuNum = this.charaData[this.tabName]["_menu"];
               ...
               this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Armband.Num = this.handNum;
               new Chara_ColorClass(this.charaNum,this.tabName);
            }
            else
            {
         ...
         {
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Elbowpad.visible = this.charaData[this.tabName]["_visible"][0];
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Elbowpad.visible = this.charaData[this.tabName]["_visible"][0];
            if(this.charaData[this.tabName]["_visible"][0])
            {
               this.menuNum = this.charaData[this.tabName]["_menu"];
               ...
               this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Elbowpad.buttonMode = true;
               this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Elbowpad.Num = this.handNum;
               this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Elbowpad.mouseChildren = false;
               this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Elbowpad.buttonMode = true;
               this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Elbowpad.Num = this.handNum;
               new Chara_ColorClass(this.charaNum,this.tabName);
            }
            else
            {
         ...
         else if(this.tabName == "Ysyatu")
         {
            ...
            try
            {
               ...
               if(this.udeAngle >= 1 && this.udeAngle <= 22)
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Ysyatu.Ysyatu.gotoAndStop(1);
               }
               else
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Ysyatu.Ysyatu.gotoAndStop(2);
               }
            }
            catch(myError:Error)
            {
         ...
         else if(this.tabName == "Tsyatu")
         {
            ...
            try
            {
               ...
               if(this.udeAngle >= 1 && this.udeAngle <= 22)
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Tsyatu.Ysyatu.gotoAndStop(1);
               }
               else
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Tsyatu.Ysyatu.gotoAndStop(2);
               }
            }
            catch(myError:Error)
            {
         ...
         else if(this.tabName == "Vest")
         {
            ...
            try
            {
               ...
               if(this.udeAngle >= 1 && this.udeAngle <= 22)
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Vest.Ysyatu.gotoAndStop(1);
               }
               else
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Vest.Ysyatu.gotoAndStop(2);
               }
            }
            catch(myError:Error)
            {
         ...
         else if(this.tabName == "Seihuku")
         {
            ...
            try
            {
               ...
               if(this.udeAngle >= 1 && this.udeAngle <= 22)
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Seihuku.Ysyatu.gotoAndStop(1);
               }
               else
               {
                  this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Seihuku.Ysyatu.gotoAndStop(2);
               }
            }
            catch(myError:Error)
            {
         ...
         else if(this.tabName == "Item")
         {
            try
            {
               this.charaAdd["handm1_" + this.handNum].hand.item.hand.actual.hand.item.mouseChildren = false;
               this.charaAdd["handm1_" + this.handNum].hand.item.hand.actual.hand.item.buttonMode = true;
               this.charaAdd["handm1_" + this.handNum].hand.item.hand.actual.hand.item.Num = this.handNum;
               if(this.charaData["Item" + 0]["_visible"][0] && Dress_data.ObjData["Item0"][this.charaData["Item" + 0]["_menu"]]["word"] == 1)
               {
                  this.charaAdd["handm1_" + 0].hand.item.hand.actual.hand.item.scaleX = -1;
               }
               else if(this.charaData["Item" + 0]["_visible"][0] && Dress_data.ObjData["Item0"][this.charaData["Item" + 0]["_menu"]]["word"] == 2)
               {
                  try
                  {
                     this.charaAdd["handm1_" + 0].hand.item.hand.actual.hand.item.reversalObj.scaleX = -1;
                  }
                  catch(myError:Error)
                  {
                  }
         ...
         if(this.charaData["Item" + this.handNum]["_visible"][0])
         {
            try
            {
               ...
               {
                  MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.item.visible = true;
               }
               MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.sen.visible = true;
               MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.color0.visible = true;
               ...
               else if(_loc16_ && Dress_data.ObjData["Item0"][this.charaData["Item" + this.handNum]["_menu"]]["arm1"] >= 1)
               {
                  ...
                  MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.item.visible = false;
                  MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.sen.visible = false;
                  MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.color0.visible = false;
               }
               ...
               if(Dress_data.ObjData["Item0"][this.charaData["Item" + this.handNum]["_menu"]]["arm1"] >= 1)
               {
                  _loc18_ = MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.getChildIndex(MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.item);
                  _loc19_ = MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.getChildIndex(MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.itemSwapMc);
                  if(_loc17_)
                  {
                     if(_loc18_ > _loc19_)
                     {
                        MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.swapChildren(MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.item,MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.itemSwapMc);
                     }
                  }
         ...
         else if(!MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.sen.visible)
         {
            try
            {
               MenuClass.charaAdd[this.charaNum]["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.sen.visible = true;
      ...
      private function Fc1(param1:int, param2:int) : void
      {
         ...
         this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[this.tabName].visible = this.charaData[this.tabName]["_visible"][0];
         this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual[this.tabName].visible = this.charaData[this.tabName]["_visible"][0];
         if(param1 == 0)
         {
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual[this.tabName].visible = false;
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual[this.tabName].gotoAndStop(1);
         }
         else
         {
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual[this.tabName].gotoAndStop(param1 + 1);
         }
         if(param2 == 0)
         {
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[this.tabName].visible = false;
            ...
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[this.tabName].gotoAndStop(1);
         ...
         {
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[this.tabName].gotoAndStop(param2 + 1);
         ...
         try
         {
            ...
            {
               this.charaAdd["handm0_" + this.handNum].shoulder[this.tabName].sen.mask = this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[this.tabName].maskMc0;
            }
            else
            {
               this.charaAdd["handm0_" + this.handNum].shoulder[this.tabName].sen.mask = null;
               this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[this.tabName].maskMc0.visible = false;
            }
         }
         catch(myError:Error)
         {
      ...
      {
         this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual[param1].mouseChildren = false;
         this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual[param1].buttonMode = true;
         this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual[param1].Num = this.handNum;
         if(param1 == "Glove")
         {
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove_mask.mouseChildren = false;
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove_mask.buttonMode = true;
            this.charaAdd["handm1_" + this.handNum].hand.arm1.arm1.arm1.actual.Glove_mask.Num = this.handNum;
         }
         this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[param1].mouseChildren = false;
         this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[param1].buttonMode = true;
         this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2[param1].Num = this.handNum;
         if(param1 == "Glove")
         {
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove_mask.mouseChildren = false;
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove_mask.buttonMode = true;
            this.charaAdd["handm0_" + this.handNum].hand.arm2.actual.arm2.Glove_mask.Num = this.handNum;
         }
      }
   }
}
