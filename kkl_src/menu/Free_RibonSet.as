      ...
      public function Free_RibonSet(param1:int, param2:String)
      {
         ...
         if(MenuClass.systemData["FreeRibonPlus"]["_visible"][param1])
         {
            ...
            try
            {
               ...
               {
                  // Chara_Class.chara_m["Ribon" + param1].ribon0.sen.alpha = 0;
                  Chara_Class.chara_m["Ribon" + param1].ribon0.sen.visible = false;
               ...
               {
                  if (MenuClass.systemData["FreeRibonLine" + param1]["_menu"] == 0) {
                     Chara_Class.chara_m["Ribon" + param1].ribon0.sen.visible = false;
                     // Chara_Class.chara_m["Ribon" + param1].ribon0.sen.alpha = 0;
                  } else {
                     // Chara_Class.chara_m["Ribon" + param1].ribon0.sen.alpha = 100;
            ...
            try
            {
               ...
               while(_loc4_ <= 3)
               {
                  ...
                  {
                     // Chara_Class.chara_m["Ribon" + param1].ribon0["ball" + _loc4_].sen.alpha = 0;
                     Chara_Class.chara_m["Ribon" + param1].ribon0["ball" + _loc4_].sen.visible = false;
