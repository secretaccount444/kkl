package fl.text
{
   ...
   public class TLFTextField extends Sprite
   {
      ...
      public function TLFTextField()
      {
         ...
         this._containerManager.hostFormat = createTextLayoutFormat(tlf_internal::_initialDefaultTextFormat);
      ...
      tlf_internal static function repeat(param1:String, param2:String) : String
      {
         var _loc3_:String = "";
         var _loc4_:int = 0;
      ...
      tlf_internal static function createTextLayoutFormat(param1:TextFormat) : TextLayoutFormat
      {
         ...
         if(param1.tabStops != null)
         {
            ...
            {
               (_loc5_ = new TabStopFormat()).alignment = TabAlignment.START;
      ...
      tlf_internal function set contentHeight(param1:Number) : void
      {
      ...
      tlf_internal function setCompositionSize(param1:Number, param2:Number) : void
      {
         this._containerManager.setCompositionSize(param1,param2);
      }
      
      tlf_internal function repaint(param1:Event = null) : void
      {
         ...
         try
         {
            ...
            {
               if(this._invalidState & (tlf_internal::INVALID_AUTO_SIZE | tlf_internal::INVALID_WORD_WRAP))
               {
                  ...
                  if(this._invalidState & tlf_internal::INVALID_WORD_WRAP)
                  {
               ...
               if(this._invalidState & tlf_internal::INVALID_TEXT && this._invalidTextLayoutFormat != null)
               {
            ...
            if(this._invalidState & (tlf_internal::INVALID_TEXT | tlf_internal::INVALID_DIMENSIONS | tlf_internal::INVALID_WORD_WRAP | tlf_internal::INVALID_AUTO_SIZE))
            {
               this._containerManager.update();
            }
            if(this._invalidState & (tlf_internal::INVALID_TEXT | tlf_internal::INVALID_DIMENSIONS | tlf_internal::INVALID_BORDER | tlf_internal::INVALID_WORD_WRAP | tlf_internal::INVALID_AUTO_SIZE))
            {
      ...
      tlf_internal function doImport(param1:String, param2:String) : void
      {
         ...
         this.invalidate(tlf_internal::INVALID_ALL);
         this.scrollV = 0;
      }
      ...
      public function set firstBaselineOffset(param1:Object) : void
      {
         ...
         this.invalidate(tlf_internal::INVALID_TEXT);
      }
      ...
      tlf_internal function getEditingMode(param1:ISelectionManager) : String
      {
      ...
      tlf_internal function addNextField(param1:TLFTextField) : void
      {
         ...
         this.invalidate(tlf_internal::INVALID_TEXT);
         param1.invalidate(tlf_internal::INVALID_TEXT);
      }
      ...
      override public function set height(param1:Number) : void
      {
         if(param1 != this._containerManager.compositionHeight)
         {
            ...
            this.invalidate(tlf_internal::INVALID_DIMENSIONS);
         }
      }
      ...
      tlf_internal function textFlow_ScrollHandler(param1:TextLayoutEvent) : void
      {
      ...
      public function set background(param1:Boolean) : void
      {
         ...
         this.invalidate(tlf_internal::INVALID_BORDER);
      }
      ...
      tlf_internal function set generationID(param1:int) : void
      {
      ...
      tlf_internal function textFlow_flowOperationEndHandler(param1:FlowOperationEvent) : void
      {
      ...
      public function get bottomScrollV() : int
      {
         ...
         var _loc4_:TextFlow;
         if((_loc4_ = this._containerManager.textFlow).blockProgression == BlockProgression.RL)
         {
      ...
      public function set alwaysShowSelection(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.focusedSelectionFormat != tlf_internal::focusedSelectionFormat)
            {
               _loc3_.focusedSelectionFormat = tlf_internal::focusedSelectionFormat;
            }
            if(_loc3_.inactiveSelectionFormat != tlf_internal::inactiveSelectionFormat)
            {
               _loc3_.inactiveSelectionFormat = tlf_internal::inactiveSelectionFormat;
            }
            _loc4_ = !!this.alwaysShowSelection ? tlf_internal::alwaysShowSelectionOnFormat : tlf_internal::alwaysShowSelectionOffFormat;
      ...
      public function set autoSize(param1:String) : void
      {
         ...
         this.invalidate(tlf_internal::INVALID_AUTO_SIZE);
      }
      ...
      tlf_internal function initController(param1:Sprite) : TLFContainerController
      {
      ...
      tlf_internal function composeComplete(param1:CompositionCompleteEvent) : void
      {
      ...
      public function set htmlText(param1:String) : void
      {
         ...
         {
            this.text = "";
            this.hostFormat = createTextLayoutFormat(tlf_internal::_initialDefaultTextFormat);
            return;
         }
         var _loc2_:TextFlow = this._containerManager.textFlow;
      ...
      tlf_internal function switchToEditingMode(param1:TextFlow, param2:String, param3:Boolean = true) : void
      {
         ...
         if(param1.interactionManager)
         {
            ...
            param1.interactionManager.focusedSelectionFormat = tlf_internal::focusedSelectionFormat;
            param1.interactionManager.inactiveSelectionFormat = tlf_internal::inactiveSelectionFormat;
            if(this.alwaysShowSelection)
            {
               param1.interactionManager.unfocusedSelectionFormat = tlf_internal::alwaysShowSelectionOnFormat;
            }
            else
            {
               param1.interactionManager.unfocusedSelectionFormat = tlf_internal::alwaysShowSelectionOffFormat;
            }
         }
         if(param3)
         {
      ...
      public function set wordWrap(param1:Boolean) : void
      {
         ...
         this.invalidate(tlf_internal::INVALID_WORD_WRAP);
      }
      ...
      public function get maxScrollV() : int
      {
         ...
         var _loc4_:int;
         var _loc5_:int = (_loc4_ = !this._containerManager.columnCount || this._containerManager.columnCount == FormatValue.AUTO ? 1 : int(int(this._containerManager.columnCount))) - 1;
         ...
         if((_loc6_ = _loc2_.getLineAt(this._maxScrollVFirstLineIndex)) == null)
         {
            this._maxScrollVCached = true;
            this._maxScrollV = 0;
            return this._maxScrollV;
         ...
         var _loc10_:*;
         if(_loc10_ = _loc1_.blockProgression == BlockProgression.RL)
         {
            if((_loc9_ = Math.round(Math.min(this._maxScrollVLastLineRect.left,this._containerManager.contentLeft) + this._containerManager.compositionWidth)) >= 0)
            {
               this._maxScrollVCached = true;
               this._maxScrollV = 0;
               return this._maxScrollV;
         ...
         else if((_loc9_ = Math.round(Math.max(this._maxScrollVLastLineRect.bottom,this._containerManager.contentHeight) - this._containerManager.compositionHeight)) <= 0)
         {
            this._maxScrollVCached = true;
            this._maxScrollV = 0;
            return this._maxScrollV;
      ...
      public function get scrollV() : int
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(!(_loc4_ = this._containerManager.getLineIndexBounds(_loc3_)).isEmpty())
            {
               if(_loc1_.blockProgression == BlockProgression.RL)
               {
                  if((_loc5_ = Math.round(this._containerManager.horizontalScrollPosition)) <= Math.round(_loc4_.right) && _loc5_ >= Math.round(_loc4_.left))
                  {
                     return _loc3_ + 1;
                  }
               }
               else if((_loc6_ = Math.round(this._containerManager.verticalScrollPosition)) <= Math.round(_loc4_.bottom) && _loc6_ >= Math.round(_loc4_.top))
               {
                  return _loc3_ + 1;
               }
            }
      ...
      tlf_internal function updateComplete(param1:UpdateCompleteEvent) : void
      {
      ...
      tlf_internal function invalidate(param1:uint) : void
      {
      ...
      tlf_internal function insertWithParagraphs(param1:EditManager, param2:String) : void
      {
         var _loc3_:Array = null;
         var _loc4_:Number = NaN;
      ...
      tlf_internal function set hostFormat(param1:ITextLayoutFormat) : void
      {
      ...
      public function setTextFormat(param1:TextFormat, param2:int = -1, param3:int = -1) : void
      {
         ...
         if(this.canUseTCMForTextFlow(this.textFlow))
         {
            ...
            {
               (_loc6_ = new TextLayoutFormat(this._containerManager.hostFormat)).concat(_loc5_);
      ...
      tlf_internal function textFlow_flowOperationBeginHandler(param1:FlowOperationEvent) : void
      {
         ...
         else if(!(_loc2_ is PasteOperation))
         {
            ...
            {
               if((_loc14_ = FlowTextOperation(_loc2_)).absoluteStart == _loc14_.absoluteEnd)
               {
                  param1.preventDefault();
                  return;
               }
      ...
      tlf_internal function set contentWidth(param1:Number) : void
      {
      ...
      tlf_internal function set isPointText(param1:Boolean) : void
      {
      ...
      private function doTypeSet(param1:TLFTextField) : void
      {
         ...
         {
            this.setSelection(this._priorSelectionBeginIndex,this._priorSelectionEndIndex);
            if(_loc2_.focusedSelectionFormat != tlf_internal::focusedSelectionFormat)
            {
               _loc2_.focusedSelectionFormat = tlf_internal::focusedSelectionFormat;
            }
            if(_loc2_.inactiveSelectionFormat != tlf_internal::inactiveSelectionFormat)
            {
               _loc2_.inactiveSelectionFormat = tlf_internal::inactiveSelectionFormat;
            }
            _loc4_ = !!this.alwaysShowSelection ? tlf_internal::alwaysShowSelectionOnFormat : tlf_internal::alwaysShowSelectionOffFormat;
      ...
      tlf_internal function set inlineInfo(param1:*) : void
      {
         this._inlineInfo = param1;
      }
      
      tlf_internal function set paddingLock(param1:Boolean) : void
      {
      ...
      public function getCharIndexAtPoint(param1:Number, param2:Number) : int
      {
         ...
         if(_loc3_)
         {
            ...
            return !!(_loc6_ = this.getCharBoundaries(_loc5_)).containsPoint(_loc4_) ? int(_loc5_) : (_loc5_ > 0 ? int(_loc5_ - 1) : int(_loc5_));
         }
         return -1;
      }
      ...
      tlf_internal function linkClick(param1:FlowElementMouseEvent) : void
      {
