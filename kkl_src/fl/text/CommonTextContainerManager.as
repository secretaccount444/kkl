   ...
   class CommonTextContainerManager
   {
      ...
      public function setTextFormat(param1:TextFormat, param2:int, param3:int, param4:TextLayoutFormat, param5:TextLayoutFormat) : void
      {
         ...
         if(param1.tabStops != null)
         {
            ...
            {
               (_loc12_ = new TabStopFormat()).alignment = TabAlignment.START;
         ...
         var _loc7_:String;
         if((_loc7_ = this._ownerField.getEditingMode(this.textFlow.interactionManager)) != EditingMode.READ_ONLY && _loc7_ != null)
         {
      ...
      public function setFormatForAllElements(param1:FlowGroupElement, param2:TextLayoutFormat) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            {
               (_loc6_ = new TextLayoutFormat(_loc5_.format)).apply(param2);
      ...
      public function getTextFormat(param1:int, param2:int) : TextFormat
      {
         ...
         var _loc4_:SelectionState = null;
         var _loc5_:String;
         if((_loc5_ = this._ownerField.getEditingMode(this.textFlow.interactionManager)) != EditingMode.READ_ONLY && _loc5_ != null)
         {
            if(this.textFlow.interactionManager.hasSelection())
            {
               _loc4_ = this.textFlow.interactionManager.getSelectionState();
         ...
         else
         {
            ...
            if(_loc9_.tabStops != null)
            {
               ...
               {
                  if((_loc19_ = _loc9_.tabStops[_loc18_]).alignment == TabAlignment.START)
                  {
         ...
         if(_loc6_ <= _loc7_)
         {
            _loc21_ = (_loc20_ = ElementRange.createElementRange(this.textFlow,_loc6_,_loc7_)).firstLeaf;
            while(_loc21_)
            {
               if((_loc22_ = _loc21_.getParentByType(LinkElement) as LinkElement) != null)
               {
                  if(_loc10_ == null)
                  {
