package fl.text
{
   ...
   class SingleTextContainerManager extends CommonTextContainerManager implements IContainerManager
   {
      ...
      override public function getTextFormat(param1:int, param2:int) : TextFormat
      {
         ...
         if((_loc4_ = !!this.hostFormat ? TextLayoutFormat(this.hostFormat) : new TextLayoutFormat()).textAlign == TextFormatAlign.LEFT || _loc4_.textAlign == TextFormatAlign.CENTER || _loc4_.textAlign == TextFormatAlign.RIGHT || _loc4_.textAlign == TextFormatAlign.JUSTIFY)
         {
         ...
         if(_loc4_.tabStops != null)
         {
            ...
            {
               if((_loc12_ = _loc4_.tabStops[_loc11_]).alignment == TabAlignment.DECIMAL)
               {
      ...
      override public function setTextFormat(param1:TextFormat, param2:int, param3:int, param4:TextLayoutFormat, param5:TextLayoutFormat) : void
      {
         ...
         if(param1.tabStops != null)
         {
            ...
            {
               (_loc10_ = new TabStopFormat()).alignment = TabAlignment.DECIMAL;
         ...
         var _loc7_:TextLayoutFormat;
         (_loc7_ = TextLayoutFormat(this.hostFormat)).apply(_loc6_);
