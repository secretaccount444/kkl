package parameter
{
   ...
   public class ColorMakeNew
   {
      ...
      public static function compute(param1:String, param2:int) {
         var _loc3_:int = 0;
         ...
         if (cache[param1][param2] !== null && cache[param1][param2] !== undefined) {
            colorStr = cache[param1][param2];
         } else {
            _loc3_ = 0;
            while(_loc3_ <= 8)
            {
