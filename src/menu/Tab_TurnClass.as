   ...
   public class Tab_TurnClass
   {
      ...
      public static function MouseDown(param1:MouseEvent) : void
      {
         ...
         if(MenuClass._nowTargetMode == "All")
         {
            ...
            {
               MenuClass.charaData[_loc6_][_loc5_]["_turn"] = int(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_turn"]);
               try
               {
         ...
         if(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_turn"])
         {
