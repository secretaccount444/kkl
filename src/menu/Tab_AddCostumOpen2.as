package menu
{
   ...
   public class Tab_AddCostumOpen2
   {
      ...
      public static var openAr:Array = [["Body","666666",1],["headAdd","666666",1],["LoadLeftArm","666666",1],["LoadRightArm","666666",1],["LoadLeftHand","666666",1],["LoadRightHand","666666",1]];
      ...
      public static function setFc(param1:String, param2:int) : void
      {
         ...
         while(_loc4_ < openAr.length)
         {
            ...
            if(MenuClass.charaData[param2]["CharaLoadAdd" + _loc10_]["_add0"] == _loc4_)
            {
      ...
      public static function MouseDown(param1:MouseEvent) : void
      {
         ...
         new ColorChangeClass(MenuClass.AddOpenAdd[MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"]].icon.icon,"CCCCCC");
         new ColorChangeClass(MenuClass.AddOpenAdd[MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"]].bg,"000000");
         MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"] = param1.currentTarget.number;
         new ColorChangeClass(MenuClass.AddOpenAdd[MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"]].icon.icon,"FFFFFF");
         new ColorChangeClass(MenuClass.AddOpenAdd[MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"]].bg,openAr[MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"]][1]);
         new ColorChangeClass(MenuClass.tabMenuAdd["CharaLoadAdd"].addBox0.bg,openAr[MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"]][1]);
         MenuClass.tabMenuAdd["CharaLoadAdd"].addBox0.icon.icon.gotoAndStop(openAr[MenuClass.charaData[_loc2_]["CharaLoadAdd" + _loc3_]["_add0"]][0]);
