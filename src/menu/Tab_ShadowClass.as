package menu
{
   ...
   public class Tab_ShadowClass
   {
      ...
      public function Tab_ShadowClass()
      {
         super();
      }
      ...
      public static function MouseDown(param1:MouseEvent) : void
      {
         ...
         if(_loc4_ == "charaPlus" || _loc4_ == "chara")
         {
            if(MenuClass._nowTargetMode == "All")
            {
               ...
               {
                  MenuClass.charaData[_loc6_][_loc5_]["_shadow"] = int(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_shadow"]);
                  try
                  {
            ...
            if(MenuClass.charaData[MenuClass._nowCharaNum][_loc5_]["_shadow"])
            {
         ...
         else
         {
            ...
            if(MenuClass.systemData[_loc5_]["_shadow"])
            {
               targetMC.gotoAndStop(3);
            }
            else
