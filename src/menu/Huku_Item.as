package menu
{
   ...
   public class Huku_Item
   {
      ...
      {
         this.charaAdd["handm1_" + this.handNum].hand.item.hand.visible = this.charaData["Item" + param1]["_visible"][0];
         if(this.charaData["Item" + param1]["_visible"][0])
         {
            this.charaAdd["handm1_" + this.handNum].hand.item.hand.gotoAndStop(this.charaData["Item" + param1]["_menu"] + 2);
            MenuClass.menuData[this.handName] = this.charaAdd["handm1_" + this.handNum].hand.item.hand.hand.totalFrames - 1;
         ...
         {
            this.charaAdd["handm1_" + this.handNum].hand.item.hand.gotoAndStop(1);
            MenuClass.menuData[this.handName] = this.charaAdd["handm1_" + this.handNum].hand.arm0.hand.totalFrames - 1;
         }
