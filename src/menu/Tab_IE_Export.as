   ...
   public class Tab_IE_Export
   {
      ...
      public static function Enter(param1:Event) : void
      {
         ...
         if(MenuClass._nowWindowName == "tabExportWindow")
         {
            ...
            if(MenuClass._nowTargetMode == "All")
            {
               MenuClass.exportCheckAdd[28].alpha = 1;
               MenuClass.exportCheckAdd[28].buttonMode = true;
            ...
            {
               MenuClass.exportCheckAdd[28].alpha = 0.2;
               MenuClass.exportCheckAdd[28].buttonMode = false;
