      ...
      public function SetCharaData(param1:int, param2:String, param3:int)
      {
         ...
         if(param3 == 0 || param3 == 2)
         {
            try
            {
               ...
               if(this.charaOldData["LeftArm"]["_meter"] == this.charaData["LeftArm"]["_meter"] && this.charaOldData["LeftArm2"]["_meter"] == this.charaData["LeftArm2"]["_meter"] && this.charaOldData["LeftArm2"]["_depth"] == this.charaData["LeftArm2"]["_depth"] && this.charaOldData["LeftHand"]["_menu"] == this.charaData["LeftHand"]["_menu"] && this.charaOldData["LeftHand2"]["_meter"] == this.charaData["LeftHand2"]["_meter"] && this.charaOldData["RightArm"]["_meter"] == this.charaData["RightArm"]["_meter"] && this.charaOldData["RightArm2"]["_meter"] == this.charaData["RightArm2"]["_meter"] && this.charaOldData["RightArm2"]["_depth"] == this.charaData["RightArm2"]["_depth"] && this.charaOldData["RightHand"]["_menu"] == this.charaData["RightHand"]["_menu"] && this.charaOldData["RightHand2"]["_meter"] == this.charaData["RightHand2"]["_meter"] && this.charaOldData["HandWidth"]["_meter"] == this.charaData["HandWidth"]["_meter"])
               {
                  _loc21_ = false;
               }
               ...
               if(this.charaOldData["EmotionMouth"]["_menu"] == this.charaData["EmotionMouth"]["_menu"] && this.charaOldData["EmotionMouth"]["_reversal"] == this.charaData["EmotionMouth"]["_reversal"])
               {
                  _loc103_ = false;
               }
               ...
               {
                  if(!(this.charaOldData["RibonPlus"]["_visible"][_loc4_] == this.charaData["RibonPlus"]["_visible"][_loc4_] && this.charaOldData["Ribon" + _loc4_]["_menu"] == this.charaData["Ribon" + _loc4_]["_menu"] && this.charaOldData["Ribon" + _loc4_]["_reversal2"] == this.charaData["Ribon" + _loc4_]["_reversal2"] && this.charaOldData["Ribon" + _loc4_]["_depth"] == this.charaData["Ribon" + _loc4_]["_depth"] && String(this.charaOldData["Ribon" + _loc4_]["_color0"][0]) == String(this.charaData["Ribon" + _loc4_]["_color0"][0]) && String(this.charaOldData["Ribon" + _loc4_]["_color1"][0]) == String(this.charaData["Ribon" + _loc4_]["_color1"][0]) && String(this.charaOldData["Ribon" + _loc4_]["_color2"][0]) == String(this.charaData["Ribon" + _loc4_]["_color2"][0]) && this.charaOldData["RibonLine" + _loc4_]["_menu"] == this.charaData["RibonLine" + _loc4_]["_menu"] && String(this.charaOldData["RibonLine" + _loc4_]["_color0"]) == String(this.charaData["RibonLine" + _loc4_]["_color0"]) && this.charaOldData["RibonScale" + _loc4_]["_meter"] == this.charaData["RibonScale" + _loc4_]["_meter"] && this.charaOldData["RibonScaleY" + _loc4_]["_meter"] == this.charaData["RibonScaleY" + _loc4_]["_meter"] && this.charaOldData["RibonScaleB" + _loc4_]["_meter"] == this.charaData["RibonScaleB" + _loc4_]["_meter"] && this.charaOldData["RibonRotation" + _loc4_]["_meter"] == this.charaData["RibonRotation" + _loc4_]["_meter"] && this.charaOldData["RibonX" + _loc4_]["_meter"] == this.charaData["RibonX" + _loc4_]["_meter"] && this.charaOldData["RibonY" + _loc4_]["_meter"] == this.charaData["RibonY" + _loc4_]["_meter"] && this.charaOldData["RibonAdd" + _loc4_]["_add0"] == this.charaData["RibonAdd" + _loc4_]["_add0"] && this.charaOldData["Ribon" + _loc4_]["_reversal"] == this.charaData["Ribon" + _loc4_]["_reversal"] && this.charaOldData["Ribon" + _loc4_]["_shadow"] == this.charaData["Ribon" + _loc4_]["_shadow"]))
                  {
                     _loc121_ = true;
                     break;
                  }
