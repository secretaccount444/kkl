   ...
   public class Tab_LoadURL
   {
      ...
      public function Tab_LoadURL(param1:String, param2:int)
      {
         ...
         try
         {
            ...
            else if(MenuClass.systemOldData["LoadPlus"]["_visible"][this.menuNum] && MenuClass.systemOldData["LoadScale" + this.menuNum]["_name"] == MenuClass.systemData["LoadScale" + this.menuNum]["_name"] && MenuClass.systemOldData["LoadScale" + this.menuNum]["_add0"] == MenuClass.systemData["LoadScale" + this.menuNum]["_add0"])
            {
               _loc3_ = false;
